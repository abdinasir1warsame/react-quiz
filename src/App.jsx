      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 h-screen items-center text-white">
        <div className=" space-y-8   w-[90%] h-2/3 items-center px-8 ml-5">
          ...
          <div className="text-xl">
            Embark on Journey Of Knowledge Exploratation with Our Extensive
            Collection Of Interactive Quizes
          </div>
          <div>
            <button className="btn-bg px-5 py-3 rounded-3xl">
              Get Started
            </button>
          </div>
        </div>
        <div className="  h-2/3 mr-8">
          <div className="flex justify-center ">
            <h2 className="text-2xl w-2/3 text-center">
